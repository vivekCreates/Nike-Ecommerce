            ...
            <div>
                <div className='flex flex-col gap-6 text-center'>
                    ...
                    <div className="w-full flex flex-col gap-2">
                        ...
                        <Button onClick={()=>handleGoogleSignIn()} variant={"outline"} className='py-6 flex items-center gap-2'>
                        ...
                        <Button onClick={()=>handleGithubSignIn()} variant={"outline"} className='py-6 flex gap-2 items-center'>
